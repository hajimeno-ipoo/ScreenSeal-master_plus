...
#ifndef SCREENSEAL_PLUS_SWIFT_H
#define SCREENSEAL_PLUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ScreenSeal_plus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15ScreenSeal_plus11AppDelegate")
...
@class NSEvent;
@class NSMenu;
SWIFT_CLASS("_TtC15ScreenSeal_plus18OverlayContentView")
...
SWIFT_CLASS("_TtC15ScreenSeal_plus13OverlayWindow")
...
@class SCStream;
SWIFT_CLASS("_TtC15ScreenSeal_plus16RecordingService") SWIFT_AVAILABILITY(macos,introduced=15.0)
@interface RecordingService : NSObject <SCStreamDelegate, SCStreamOutput>
...
SWIFT_CLASS("_TtC15ScreenSeal_plus20ScreenCaptureService")
